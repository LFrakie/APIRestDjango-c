...
let virtual-env = "/root/developer/dev-lfrakie/proyectos/APIRestDjango-cp"
let bin = "bin"
let path-sep = ":"
...
alias deactivate = source "/root/developer/dev-lfrakie/proyectos/APIRestDjango-cp/bin/deactivate.nu"
